      ...
      <section className="relative w-full bg-[#1B3A6B] pt-20 pb-32 sm:pt-32 sm:pb-48 flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto flex flex-col items-center">
          ...
          <div className="mb-6 flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-5 py-2">
            ...
            <span className="text-white/90 font-bold text-sm tracking-wide">조국혁신당 신안군의원 예비후보</span>
          </div>
          ...
          <div className="w-52 h-52 sm:w-68 sm:h-68 mb-10 rounded-full bg-gradient-to-tr from-blue-50 to-white/90 border-8 border-white/10 shadow-2xl overflow-hidden shadow-[#1B3A6B]/50 flex items-center justify-center relative" style={{ width: '14rem', height: '14rem' }}>
            <Image src="/candidate_face.png" alt="이의환 후보" fill className="object-cover object-top hover:scale-105 transition-transform duration-700" />
          </div>
      ...
      <section className="bg-[#152d54] pt-14 pb-20 px-4">
        <div className="max-w-lg mx-auto">
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            <h2 className="text-xl font-black text-white tracking-tight">이의환 신안사랑 최신 쇼츠</h2>
          </div>
      ...
      <section className="py-16 bg-gray-100 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-600 font-bold mb-10 text-lg break-keep">
            가선거구 지도읍·증도면·임자면 맞춤 공약을 확인하세요
          </p>
          <div className="flex flex-wrap justify-center gap-3 mb-10">
            {['지도읍', '증도면', '임자면'].map((name) => (
              <Link
                key={name}
                href={`/regions#${name}`}
          ...
          <div className="mt-12 w-full max-w-2xl">
            <div className="bg-white/10 backdrop-blur rounded-3xl p-8 text-center border border-white/20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
                <a href="tel:01036317754" className="flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white font-bold px-6 py-3 rounded-2xl transition-all">
                  📞 010-3631-7754
                </a>
                <a href="mailto:nanoset@naver.com" className="flex items-center gap-2 bg-white/20 hover:bg-white/30 text-white font-bold px-6 py-3 rounded-2xl transition-all">
                  ✉️ nanoset@naver.com
                </a>
              </div>
              <p className="text-blue-200 text-sm mt-4 font-medium">전라남도 신안군 임자면 진리 265-61</p>
            </div>
          </div>
